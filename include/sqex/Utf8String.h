...
#ifndef XIVL_DECOMP_SQEX_UTF8STRING_H
#define XIVL_DECOMP_SQEX_UTF8STRING_H
...
private:
    ...
    // The inline buffer is int[16] instead of char[64] (same 64 bytes total)
    // to bypass MSVC /GS's char-array auto-guard heuristic. It is wrapped in
    // pack(2) so int alignment
...
#endif // XIVL_DECOMP_SQEX_UTF8STRING_H
