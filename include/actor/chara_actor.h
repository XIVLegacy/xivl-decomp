...
//     and NPC); slot-specific roles are not established.
//
...
// fragile and not necessary. The offsets identify fields targeted by
...
//
// Use these constants to identify a CharaActor field, e.g.:
//
//   set_actor_property(actor_id,
//                      CHARA_ACTOR_OFFSET::flags_2b70,
//                      bit_set);

#ifndef XIVL_DECOMP_ACTOR_CHARA_ACTOR_H
#define XIVL_DECOMP_ACTOR_CHARA_ACTOR_H

#include <stddef.h>

namespace xivl_decomp
{
namespace actor
{
...
// ---- Early fields (possibly inherited from base Actor class) ----
static const size_t field_0114      = 0x0114; // (dtor-only; type unknown)
static const size_t parent_or_owner = 0x0118; // dword, accessed early in ctor; back-reference not established
...
//   integer literals in the 0xC0..0xF0 (192..240) range - possibly
...
//   string referencing 0x1a0-byte buffer). Possibly the "secondary"
...
#endif // XIVL_DECOMP_ACTOR_CHARA_ACTOR_H
