...
generator and provenance caveats are recorded in each file. The `actor/`,
`install/`, `net/`, and `sqex/` directories contain curated headers for
evidence-backed interfaces and catalogs. Preserve their offsets, ABI
constraints, locators, and provenance when changing them.
