...
**FUN_00cc7170 is a registry method** absent from the prior roster.
The `0x00cc7` cluster now has **7 known methods**:

| RVA | Phase | Role |
|---|---|---|
| `0x00cc70b0` | xref-only | Likely add/remove sibling |
| `0x00cc7170` | **#2 (this page)** | **Fallback dispatch call; exact semantics are unresolved** |
| `0x00cc7180` | Existing | Sibling predicate using `[+0x1c8]` classifier |
| `0x00cc7190` | xref-only | Likely add/remove sibling |
| `0x00cc72a0` | Existing | Read actor's `+0x7d` flag (alias resolver wrapper) |
| `0x00cc78c0` | Existing | Heavyweight "find or queue placeholder" |
| `0x00cc7a50` | Existing | `ActorRegistry::lookup_actor` |
