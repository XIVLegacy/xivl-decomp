...
The typed scan of 287 mapped layout DATs found no ASCII references
...
Gridania's town layout DAT `0x29B00001` (SHA-256
...
named bytes and bounded negative scan were checked against the DAT bytes.
