...
The normal asset-free checks above remain the merge requirement. The additional
...
xref assertion and exact input/toolchain contract documented for that check; it
