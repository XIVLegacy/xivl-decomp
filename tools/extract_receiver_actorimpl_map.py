#!/usr/bin/env python3
"""Map each Receiver class to the LuaActorImpl / NullActorImpl vtable slot
that dispatches to it.

The 43 Receiver classes do not have direct CALL-rel32 callers.
...
fields of a higher-level event handler and invoked through that owner's
