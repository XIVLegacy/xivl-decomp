...
Background (`docs/actor/world-master.md`): each Lua-bindable class
...
Required: `build/lpb/` populated with `tools/decode_lpb.py`.
...
def main() -> int:
    ...
    with md_path.open("w") as f:
        ...
        f.write("by hand - re-run after decoding LPB files if the install changes.\n\n")
