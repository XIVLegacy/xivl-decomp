...
Per `docs/actor/player-base-class.md`, every C++-bound method on
...
This is the client state-field requirement catalog. Every listed field
must be populated through SetActorProperty or work-sync packets for the
client scripts to behave.
...
def main() -> int:
    ...
    with out_md.open("w") as f:
        ...
        f.write("the decompiled Lua input if the install changes.\n\n")
